  ...
  return (
    <div className={`control flex items-center gap-2 pl-3 pr-1.5 ${className}`}>
      ...
      <input
        ...
        className="flex-1 min-w-0 py-[10px] text-[15px] bg-transparent outline-none focus-visible:outline-none placeholder:text-ink-3 placeholder:italic [&::-webkit-search-cancel-button]:hidden"
        {...props}
      />
      {value && (
        <button
